...
class EnglishZoneZoomListener implements ShouldBroadcast
{
    ...
    public $tipe_model; // db EnglishZoneZoom
    public $action; // macam" action CRUD EnglishZoneZoom (create, update, delete)
    ...
    {
        return new Channel('managementZoom');
    }

    public function broadcastAs(): string
    {
        return 'management.zoom';
    }
}