...
class EnglishZoneUnitListener implements ShouldBroadcast
{
    ...
    public $tipe_model; // db EnglishZoneUnit
    public $action; // macam" action CRUD EnglishZoneUnit (create, update, delete)
    ...
    {
        return new Channel('managementUnit');
    }
