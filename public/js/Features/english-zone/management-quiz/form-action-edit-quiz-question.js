...
function paginateBankSoalEditQuestionQuizEZ() {
    ...
    if (!levelId || !questionId || !passageId || !passageType) return;

    $.ajax({
        url: `/english-zone/management-quiz/management-passage/${levelId}/${passageId}/${passageType}/${questionId}/bank-soal/edit/form`,
        method: 'GET',
        success: function (response) {
            ...
            const formHtml = `
                <form id="bank-soal-edit-question-form" data-level-id="${levelId}" data-passage-id="${passageId}" data-passage-type="${passageType}" data-question-id="${questionId}"
...
$(document).ready(function () {
    $(document).on('submit', '#bank-soal-edit-question-form', function (e) {
        ...
        $.ajax({
            url: `/english-zone/management-quiz/management-passage/${levelId}/${passageId}/${passageType}/${questionId}/bank-soal/edit/submit`,
            method: 'POST',
            headers: {
            ...
            success: function (response) {
                ...
                // inisialiasi paginateBankSoalEditQuestionQuizEZ() setelah berhasil edit question
                paginateBankSoalEditQuestionQuizEZ();
            },
