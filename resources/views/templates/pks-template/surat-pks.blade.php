                        ...
                        <form action="{{ route('suratPKS.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex flex-col w-full mb-8">
                                ...
                                <select name="tipe_surat_pks"
                                    class="bg-white shadow-lg h-12 border-gray-200 border-[2px] outline-none rounded-md px-2 focus:border-[1px] focus:border-[dodgerblue] focus:shadow-[0_0_9px_0_dodgerblue] cursor-pointer {{ $errors->has('tipe_surat_pks') ? 'border-[1px] border-red-400' : '' }}">
