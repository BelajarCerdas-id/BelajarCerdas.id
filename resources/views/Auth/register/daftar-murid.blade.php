...
<div class="min-h-screen flex items-center justify-center bg-[url('/image/register/background-register.png')] bg-cover">
    <div class="bg-white rounded-xl shadow-md w-full max-w-xl p-6 mx-8">
        ...
        <div class="flex items-center justify-between mx-8 gap-2">
            ...
            <div class="flex items-center gap-2">
                <div id="step-indicator-2" class="flex flex-col items-center text-gray-400 font-bold relative">
                    ...
                    <span class="text-sm mt-1 absolute top-10 text-center w-max">Sekolah</span>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2">
                <div id="step-indicator-3" class="flex flex-col items-center text-gray-400 font-bold relative">
                    ...
                    <span class="text-sm mt-1 absolute top-10 text-center w-max">Akun</span>
                </div>
            </div>
        ...
        <form id="register-form" action="{{ route('registerStudent.store') }}" method="POST" class="mt-6">
            @csrf
            <!-- STEP 1 -->
            ...
            <div id="step-2" class="step hidden">
                <!-- Sekolah -->
                <div class="flex flex-col">
                    <label for="sekolah" class="mb-2 text-sm mt-8">Nama Sekolah<sup
                            class="text-red-500 pl-1">&#42;</sup></label>
                ...
                <!-- Fase -->
                <div class="flex flex-col">
                    <label for="fase_id" class="mb-2 text-sm mt-4">Fase<sup
                            class="text-red-500 pl-1">&#42;</sup></label>
            ...
            <div id="step-3" class="step hidden">
                ...
                <!-- Password -->
                <div class="flex flex-col">
                    <label for="password" class="mb-2 text-sm mt-4">Password<sup
                            class="text-red-500 pl-1">&#42;</sup></label>
    ...
    <script>
        ...
        function startResendCountdown() {
            ...
            fetch("{{ route('register.sendOtpMailStudent') }}", {
                    method: 'POST',
                    headers: {
        ...
        function nextStep(step) {
            ...
            fetch("{{ route('register.validateStepFormStudent') }}", {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
