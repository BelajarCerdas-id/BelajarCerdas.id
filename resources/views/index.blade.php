...
<main>
    ...
    <section class="hidden lg:grid grid-cols-12 relative">
        <div class="col-span-12 md:col-span-6 flex items-center justify-center relative z-[-1]">
        ...
        <div class="col-span-12 md:col-span-6 h-[550px] relative flex justify-center z-[-1]">
            <!----- rounded mid  ----->
            <div
    ...
    <section class="lg:hidden relative">
        <div class="mx-4 flex flex-col items-center">
            ...
            <div class="w-full md:text-left h-full flex flex-col justify-center gap-6 my-20">
                ...
                <div class="w-full xl:w-[78%] flex flex-wrap mt-[1px]">
                    <span class="text-justify leading-6 flex-grow">
                        Belajar Cerdas ID adalah platform edukasi inovatif yang membantumu memahami materi
                        dengan
                        lebih
                        mudah, cepat, dan efektif.
                        Dengan metode pembelajaran yang interaktif dan berbasis konsep, kami siap menemanimu
                        meraih
                        prestasi terbaik!.
                    </span>
                </div>
            ...
            <div
                ...
                <div class="">
                    ...
                    <p class="text-sm text-justify">
                        ...
                        dan mentor dapat mendaftar secara mandiri, dan interaksi berlangsung melalui Zoom dengan
    ...
    <!-- Our Best Service (Mobile) -->
    <div class="relative flex justify-center items-center min-h-screen p-6 lg:hidden mt-20 sm:mt-0">
        <!-- Main Content -->
        <div
                    ...
                    <div class="relative w-full h-full flex overflow-hidden flex-col mt-6">
                        ...
                        <div class="w-full h-full flex flex-col duration-700 ease-out hidden"
                            ...
                            <p class="text-gray-600 text-sm md:text-base leading-6 md:leading-8">
                                ...
                                mentor pilihan mereka. Siswa
                                dan
                                mentor dapat mendaftar secara mandiri, dan interaksi berlangsung melalui Zoom dengan
                                durasi
                                90 menit per sesi.
                            </p>
                            <p class="mt-4 text-gray-600 text-sm md:text-base leading-6 md:leading-8">
    ...
    @foreach ($features as $item)
        <article class="border h-[600px] rounded-lg relative">
            ...
            <figure class="border-b border-gray-200 h-32">
                <img src="{{ $descriptionsFeatures[$item->nama_fitur]['image_feature'] ?? '' }}" loading="lazy"
            ...
            <div class="flex justify-center items-center">
                ...
                <div class="bg-[--color-default] w-52 h-52 md:w-80 md:h-80 rounded-full relative">
                    <div class="w-[300px] md:w-[460px] relative left-[-24%] md:left-[-23%] top-[-25%] z-20">
                        <!-- Image -->
                        <img src="image/asset_belajarcerdas2-01.png" loading="lazy" alt="Person with laptop"
                            class="">
                    </div>
...
<div class="relative flex justify-center items-center p-6">
    ...
    <div class="relative rounded-lg shadow-xl border-[1px] border-gray-200 w-full max-w-[1500px] h-auto p-6 md:p-10">
        ...
        <div class="relative grid grid-cols-1 md:grid-cols-2 gap-6 h-auto my-20">
            ...
            <!-- Right Side: Text Content -->
            <div class="flex flex-col justify-center relative mb-32">
                <div class="flex gap-2">
                    <h1 class="text-2xl sm:text-4xl font-bold absolute top-0 text-gray-800 md:top-6 flex gap-2">
                ...
                <div class="flex flex-col gap-4">
                    <div class="flex gap-2">
                        <img src="{{ asset('image/globe-icon.png') }}" loading="lazy" alt=""
                    ...
                    <div class="flex gap-2">
                        <img src="{{ asset('image/science-icon.png') }}" loading="lazy" alt=""
                            class="w-6 object-contain">
                        <span class="text-justify text-sm">
