    ...
    <div class="home-beranda z-[-1] md:z-0 mt-[80px] md:mt-0">
        <div class="content-beranda">
            <div class="flex justify-start my-4">
                <a href="{{ route('BulkUpload-excel') }}">
                    <button
                        class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg shadow-md transition-all">
                        Download Template
                    </button>
                </a>
            </div>
            <main>
                <section class="bg-white shadow-lg p-6 rounded-lg border-gray-200 border-[1px]">
                    ...
                    <form action="{{ route('import-data-murid') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="w-full">
                            <div class="w-full h-auto">
                                <span class="text-sm">Upload Template<sup class="text-red-500 pl-1">&#42;</sup></span>
