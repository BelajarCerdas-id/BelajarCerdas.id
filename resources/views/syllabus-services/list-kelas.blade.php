...
<script src="{{ asset('js/syllabus-services/paginate-syllabus-kelas-ajax.js') }}"></script> <!--- paginate kelas ---->
...
<!--- PUSHER LISTENER ---->
<script src="{{ asset('js/pusher-listener/syllabus-services/list-kelas-listener.js') }}"></script> <!--- pusher listener list kelas ---->
