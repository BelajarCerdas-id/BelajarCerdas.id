...
<script src="{{ asset('js/syllabus-services/paginate-syllabus-fase-ajax.js') }}"></script> <!--- paginate fase ---->
...
<!--- PUSHER LISTENER ---->
<script src="{{ asset('js/pusher-listener/syllabus-services/list-fase-listener.js') }}"></script> <!--- pusher listener list fase ---->
