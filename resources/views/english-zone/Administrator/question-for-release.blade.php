@include('components/sidebar_beranda', ['headerSideNav' => 'Question For Release'])
        ...
        <div class="content-beranda">
            ...
            <form action="{{ route('questionForRelease.update') }}" method="POST">
                <div class="relative w-full h-9">
                    <button
                        class="absolute right-14 bg-[#4189e0] w-[150px] h-8 text-white font-bold rounded-lg text-xs hidden"
