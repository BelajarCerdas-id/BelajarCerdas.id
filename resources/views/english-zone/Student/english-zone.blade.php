                                ...
                                <div class="wrapper-content-accordion">
                                    ...
                                    <div class="content-accordion">
                                        <div class="wrapper-content-accordion1">
                                            <div class="box-content-accordion !p-0">
                                                <div class="flex items-center gap-4">
                                                    <div class="">
                                                        <img src="{{ asset('image/logo-fitur/logo-englishZone.png') }}"
                                                            alt="" class="w-[80px]">
                                                    </div>
                                                ...
                                                @else
                                                    <button class="button-link-materi mr-4">
                                                        <div onclick="showMateri(this)"
                                                            data-pdf="{{ asset('englishZone_pdf/' . $item->materi_pdf) }}">
                                                            Lihat Materi
                                            ...
                                            <div class="box-content-accordion !p-0">
                                                ...
                                                @else
                                                    <button class="button-link-videoList mr-4">
