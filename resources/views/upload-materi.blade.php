                ...
                <div class="relative w-full h-auto overflow-hidden bg-white shadow-lg">
                    <div class="w-full h-auto px-4 my-4 relative" id="content">
                        <div class="pt-6 mb-4">
                            ...
                            <label for="soal" class="radioList" onclick="wrapperMateri()">
                                <a>Materi</a>
                            </label>
                            <input type="radio" name="tipeUpload" id="bulkUpload">
                            <label for="bulkUpload" class="radioList" onclick="wrapperSertifikat()">
                                <a>Sertifikat</a>
                            </label>
                        </div>
                        <form action="{{ route('englishZone.uploadMateri') }}" method="POST"
                            ...
                            <div class="w-full h-auto">
                                <div id="wrapperMateri">
                                    <div class="grid grid-cols-12 md:gap-8">
                                        <div class="col-span-12 md:col-span-6">
                                            <label class="mb-2 text-sm">Modul<sup
                                                    class="text-red-500 pl-1">&#42;</sup></label>
                                            <select name="modul"
                                                class="w-full bg-gray-100 outline-none rounded-xl text-xs p-3 cursor-pointer mt-4 mb-2 {{ $errors->has('modul') ? 'border-[1px] border-red-500' : '' }}"
                                                onchange="showModulDownload()">
                                                <option value="" class="hidden">Pilih Modul</option>
                                                <option value="Modul 1"
                                                    {{ @old('modul') === 'Modul 1' ? 'selected' : '' }}>Modul 1
                                                </option>
                                                <option value="Modul 2"
                                                    {{ @old('modul') === 'Modul 2' ? 'selected' : '' }}>Modul 2
                                                </option>
                                                <option value="Modul 3"
                                                    {{ @old('modul') === 'Modul 3' ? 'selected' : '' }}>Modul 3
                                                </option>
                                                <option value="Modul 4"
                                                    {{ @old('modul') === 'Modul 4' ? 'selected' : '' }}>Modul 4
                                                </option>
                                                <option value="Modul 5"
                                                    {{ @old('modul') === 'Modul 5' ? 'selected' : '' }}>Modul 5
                                                </option>
                                                <option value="Modul 6"
                                                    {{ @old('modul') === 'Modul 6' ? 'selected' : '' }}>Modul 6
                                                </option>
                                                <option value="Modul 7"
                                                    {{ @old('modul') === 'Modul 7' ? 'selected' : '' }}>Modul 7
                                                </option>
                                                <option value="Modul 8"
                                                    {{ @old('modul') === 'Modul 8' ? 'selected' : '' }}>Modul 8
                                                </option>
                                        ...
                                        <div class="col-span-12 md:col-span-6">
                                            ...
                                            <select name="jenjang_murid"
                                                class="w-full bg-gray-100 outline-none rounded-xl text-xs p-3 cursor-pointer mt-4 mb-2 {{ $errors->has('jenjang_murid') ? 'border-[1px] border-red-500' : '' }}">
                                                <option value="" class="hidden">Pilih Jenjang</option>
                                                <option value="SD"
                                                    {{ @old('jenjang_murid') === 'SD' ? 'selected' : '' }}>SD</option>
                                                <option value="SMP"
                                                    {{ @old('jenjang_murid') === 'SMP' ? 'selected' : '' }}>SMP
                                                </option>
                                                <option value="SMA"
                                                    {{ @old('jenjang_murid') === 'SMA' ? 'selected' : '' }}>SMA
                                                </option>
                                                <option value="Guru"
                                                    {{ @old('jenjang_murid') === 'Guru' ? 'selected' : '' }}>Guru
                                                </option>
                                            </select>
                                            @error('jenjang_murid')
                                                <span
                                    ...
                                    <div class="md:w-[49%] mt-8">
                                        ...
                                        <input type="text" name="judul_modul"
                                            class="w-full bg-gray-100 outline-none rounded-xl text-xs p-3 cursor-pointer mt-4 mb-2 {{ $errors->has('judul_modul') ? 'border-[1px] border-red-500' : '' }}"
                                            ...
                                            <div class="materi grid grid-cols-12 md:gap-8 mt-8">
                                                ...
                                                <div class="col-span-12 md:col-span-6">
                                                    ...
                                                    <input type="text" name="judul_video[]"
                                                        class="w-full bg-gray-100 outline-none rounded-xl text-xs p-3 cursor-pointer mt-4 mb-2 {{ $errors->has('judul_video.' . $index) ? 'border-[1px] border-red-500' : '' }}"
                                                ...
                                                <div class="col-span-12 md:col-span-6 relative">
                                                    ...
                                                    <input type="url" name="link_video[]"
                                                        class="w-full bg-gray-100 outline-none rounded-xl text-xs p-3 cursor-pointer mt-4 mb-2 {{ $errors->has('link_video.' . $index) ? 'border-[1px] border-red-500' : '' }}"
                                    ...
                                    <div class="grid grid-cols-12 md:gap-8">
                                        ...
                                        <div class="col-span-12 md:col-span-6 mt-10 md:mt-[-2px] hidden"
                                            id="uploadModul">
                                            <div class="w-full">
                                                <div class="w-full h-auto">
                                                ...
                                                <div
                                                    ...
                                                    <input id="file-upload-modul" name="modul_download"
                                                        class="hidden" onchange="previewPDF(event, 'modul')"
                        ...
                        <div class="hidden" id="wrapperSertifikat">
                            <!-- Upload Sertifikat -->
                            <form action="{{ route('certificate.store') }}" method="POST"
                                ...
                                <div class="col-span-12 md:col-span-6 mt-10">
                                    ...
                                    <div
                                        class="content-upload w-full h-10 bg-red-500 text-white font-bold rounded-lg mt-6 mb-2">
                                ...
                                <div class="w-full relative flex justify-end">
                                    <button
                                        class="bg-red-500 w-full md:w-[200px] h-8 text-white font-bold rounded-lg mt-20 mb-8 md:mx-2">Kirim</button>
                                </div>
                            </form>
                        </div>
                    </div>
