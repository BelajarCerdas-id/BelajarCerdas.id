    ...
    <div class="home-beranda z-[-1] md:z-0 mt-[80px] md:mt-0">
        <div class="content-beranda">
            <main>
                ...
                <section id="container-quiz-reading-exam-test" data-level-id="{{ $levelId }}">
                    <!-- show content in ajax -->
                </section>
                <div class="pagination-container-question-reading-exam-test"></div>
            </main>
        </div>
    </div>
@else
...
<script src="{{ asset('js/Features/english-zone/student/quiz/english-zone-reading-exam-test.js') }}"></script> <!--- quiz reading exam test ---->