@include('components/sidebar_beranda', ['headerSideNav' => 'Student Batch'])
                        ...
                        <table class="table" id="table-management-student-batch">
                            <thead class="thead-table-management-student-batch hidden">
                                <tr>
                                    ...
                                    <th class="th-table text-black opacity-70">Mentor Pengajar</th>
                                </tr>
                            </thead>
...
<script
    src="{{ asset('js/Features/english-zone/management-student-batch/content-management-student-batch-toggle.js') }}">
</script> <!--- content management student batch toggler ---->

<script src="{{ asset('js/Features/english-zone/management-student-batch/paginate-student-batch-non-school-partner.js') }}">
</script> <!--- paginate management student batch non school partner ---->

<script src="{{ asset('js/Features/english-zone/management-student-batch/paginate-student-batch-school-partner.js') }}">
</script> <!--- paginate management student batch school partner ---->

<!--- PUSHER LISTENER ---->
<script src="{{ asset('js/pusher-listener/english-zone/management-student-batch-reschedule.js') }}"></script> <!--- pusher listener pada saat reschedule student batch ----->
<script src="{{ asset('js/pusher-listener/english-zone/management-student-batch-refund.js') }}"></script> <!--- pusher listener pada saat refund student batch ----->