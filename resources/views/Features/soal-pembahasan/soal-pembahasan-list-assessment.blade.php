                    ...
                    <div class="flex flex-col xl:flex-row gap-6">
                        ...
                        <div class="flex-1 overflow-auto bg-white shadow-lg border rounded-md">
                            ...
                            <div class="p-4 rounded-lg mb-6">
                                <p class="text-lg font-bold opacity-70">Asesmen</p>
                            </div>

                            <!-- Grid -->
                            <ul class="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 border-t">
                                <a
                                    href="{{ route('soalPembahasanSubBab.view', [$kelas, $kelas_id, $mata_pelajaran, $mapel_id, $bab_id]) }}">
                                    <li
                                        class="flex items-center justify-between gap-3 p-3 rounded-lg cursor-pointer hover:bg-gray-200">
                                        <span class="font-bold opacity-70 text-sm">Latihan</span>
                                        <i class="fa-solid fa-chevron-right text-xs"></i>
                                    </li>
                                </a>
                                <a
                                    href="{{ route('soalPembahasanAssessment.exam', [$kelas, $kelas_id, $mata_pelajaran, $mapel_id, $bab_id]) }}">
                                    <li
                                        class="flex items-center justify-between gap-3 p-3 rounded-lg cursor-pointer hover:bg-gray-200">
                                        <span class="font-bold opacity-70 text-sm">Ujian</span>
                                        <i class="fa-solid fa-chevron-right text-xs"></i>
                                    </li>
                                </a>
                            </ul>
